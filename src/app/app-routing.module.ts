...
const routes: Routes = [
  ...
  children:[
   ...
   { path:'quickview/:book._id',component:QuickviewComponent},  // we are giving /:book._id just for setting path for getting particular book by its id and we can give any name instead of book._id
